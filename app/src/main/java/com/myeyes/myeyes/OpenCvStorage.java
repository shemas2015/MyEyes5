...
public class OpenCvStorage extends Imagen {
    ...
    public OpenCvStorage(MainActivity mainActivity){
        super(mainActivity);
    ...
    /**
     * Obtiene el mapa de disparidad de dos imágenes almacenadas en memoria
     * @return
     */
    public Mat disparityMap(){
        ...
        //Obtiene las imágenes de la sdcard
        Mat left =null;
        Mat right =null;
        try{

            left =  this.imgToMat("/sdcard/left.jpg");
            right =  this.imgToMat("/sdcard/right.jpg");


            Imgproc.GaussianBlur(left,left, new Size(15, 15), 0);
            Imgproc.GaussianBlur(right,right, new Size(15, 15), 0);


            //return left;
            Mat disparity = super.disparityMap(left,right);


            disparity.convertTo(disparity,CvType.CV_8UC1);

            System.out.println("Errorw: columnas "+disparity.cols());
            return disparity;
            ...
            System.out.println("Errorw: "+ex.getMessage());
